...
<li role="presentation">
    <a role="menuitem" tabindex="-1" href="/<?php echo $root?>/users/">Manage Users
...
<li role="presentation"><a role="menuitem" tabindex="-1" href="/<?php echo $root?>/users/add">Add New User</a></li>
<li role="presentation" class="divider"></li>
...
<li role="presentation">
    <a role="menuitem" tabindex="-1" href="/<?php echo $root?>/users/updateThrustFromRepo" onclick="showUpdateThrustModal()">Update Thrust
