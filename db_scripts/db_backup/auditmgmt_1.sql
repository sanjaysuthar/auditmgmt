...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 13, 2015 at 07:05 AM
...
(51, 'ext.gvanangamudy', 'Gayathri', 'Vanangamudy', 'Application', 'RTC  [MRS-SV-02104 ( 10.0.101.188)]', 'PROD', 'CS', 'Personal', 'R/W', 'ext.gvanangamudy'),
...
--
ALTER TABLE `access_details`
MODIFY `accessid` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=116;
--
-- AUTO_INCREMENT for table `audit_details`
--
ALTER TABLE `audit_details`
MODIFY `auditid` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Audit Id',AUTO_INCREMENT=49;
